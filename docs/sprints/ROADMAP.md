...
- ✅ `requires_encryption?/1` compatibility policy function (conversation security policy boundary)
...
- ⚠️ Remaining key lifecycle hardening (revocation strategy + device/user removal semantics) is still pending
