...
- [x] Add "Local Storage Privacy Stance" section to SPEC.md — implementers cannot distinguish intentional persistence from missing security → .tmp/2026-03-19-local-first-storage/round-1/consensus.md | P1-confidence | agent:consensus (promoted 2026-03-19)
- [x] Resolve SPEC:645 [CONFLICT] data preservation vs. data minimization — unresolved tension blocks consistent storage decisions across SPA → .tmp/2026-03-19-local-first-storage/round-1/consensus.md | P1-confidence | agent:consensus (promoted 2026-03-19)
...
- [ ] Add "Clear local data" button to SPA settings (clears messages, preserves MLS keys) — shared-device users need data removal without losing session → .tmp/2026-03-19-local-first-storage/round-1/consensus.md | P2-debt | agent:consensus
