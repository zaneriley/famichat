defmodule Famichat.Chat.ConversationChangesetTest do
  ...
  describe "conversation changesets" do
    ...
    test "create_changeset enforces required fields", %{family: family} do
      ...
      changeset =
        Conversation.create_changeset(%Conversation{}, %{family_id: family.id})
    ...
    test "create_changeset validates group conversation metadata", %{
      family: family
    } do
    ...
    test "create_changeset handles hidden_by_users field", %{
      family: family,
      user1: user1
    } do
      changeset =
    ...
    test "update_changeset prevents changing conversation_type", %{
      family: family
    } do
    ...
    test "update_changeset allows updating hidden_by_users", %{
      family: family,
      user1: user1,
      user2: user2
    } do
      ...
      changeset =
        Conversation.update_changeset(updated_conversation, %{
