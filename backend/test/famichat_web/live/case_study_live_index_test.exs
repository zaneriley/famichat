defmodule FamichatWeb.CaseStudyLiveIndexTest do
  ...
  test "sets the default locale in mount/3", %{conn: conn} do
    ...
    user_locale =
      get_session(conn, :user_locale) ||
        Application.get_env(:famichat, :default_locale)
  ...
  test "sets /ja/ locale in mount/3", %{conn: conn} do
    ...
    # Set the user_locale in the session
    # user_locale = get_session(conn, :user_locale) || Application.get_env(:famichat, :default_locale)
    user_locale = "ja"
