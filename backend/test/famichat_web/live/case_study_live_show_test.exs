defmodule FamichatWeb.CaseStudyLive.ShowTest do
  use FamichatWeb.ConnCase
  import Phoenix.LiveViewTest
  alias FamichatWeb.Router.Helpers, as: Routes
  import Famichat.ContentFixtures
  alias Famichat.Repo
  require Logger
  ...
  describe "Case Study Show" do
    ...
    test "displays Japanese translation when locale is set to ja", %{conn: conn} do
      ...
      Famichat.Content.TranslationManager.create_or_update_translations(
        case_study,
        "ja",
        %{
          "title" => "日本語のタイトル",
      ...
      case_study =
        Famichat.Repo.preload(case_study, :translations, force: true)
